...
class PPOAlgorithm(object):
    ...
    """
        with tf.name_scope('perform/'):
            ...
            if self._last_state is None:
                ...
                assign_state = utility.assign_nested_vars(self._last_state, output.state,
                                                          agent_indices)
    ...
    """
        with tf.name_scope('training'):
            ...
            update_summary = self._perform_update_steps(observ, action, old_mean, old_logstd,
                                                        reward, length)
    ...
    """
        ...
        value_loss, policy_loss, summary = tf.scan(
            lambda _1, _2: self._update_step(observ, action, old_mean, old_logstd, reward,
                                             advantage, length),
