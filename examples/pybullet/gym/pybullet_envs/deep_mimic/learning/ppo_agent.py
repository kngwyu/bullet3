...
class PPOAgent(PGAgent):
    ...
    def _build_losses(self, json_data):
        ...
        a_bound_loss = TFUtil.calc_bound_loss(self._norm_a_mean_tf, norm_a_bound_min,
                                              norm_a_bound_max)
    ...
    def _build_solvers(self, json_data):
        ...
        self._actor_stepsize_tf = tf.get_variable(
            dtype=tf.float32, name='actor_stepsize', initializer=actor_stepsize, trainable=False)
    ...
    def _train_step(self):
        ...
        for e in range(self.epochs):
            ...
            for b in range(mini_batches):
                ...
                critic_g = self.replay_buffer.get('goals',
                                                  critic_batch) if self.has_goal() else None
                ...
                actor_g = self.replay_buffer.get("goals",
                                                 actor_batch[:, 0]) if self.has_goal() else None
