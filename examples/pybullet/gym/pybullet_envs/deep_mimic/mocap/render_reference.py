...
# General arguments
parser.add_argument(
    '--dataset_path', default='data/data_3d_h36m.npz', type=str,
...
parser.add_argument(
    '--loop', default='wrap', type=str, help='loop information in deepmimic, wrap or none.')
...
for utNum in range(motion.NumFrames()):
    ...
    if draw_gt:
        draw_ground_truth(
            coord_seq=ground_truth, frame=utNum, duration=keyFrameDuration, shift=[-1.0, 0.0, 1.0])
    time.sleep(0.001)
stage = 0
