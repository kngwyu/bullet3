...
class HumanoidPose(object):
    ...
    def Slerp(self, frameFraction, frameData, frameDataNext, bullet_client):
        ...
        self._neckVel = self.ComputeAngVel(neckRotStart, neckRotEnd, keyFrameDuration,
                                           bullet_client)
...
class Humanoid(object):
    ...
    def ApplyPose(self, pose, initializeBase, initializeVelocities, humanoid, bc):
        ...
        bc.setJointMotorControlMultiDof(
            ...
            force=[200])
        bc.setJointMotorControlMultiDof(
            humanoid, neck, controlMode, targetPosition=pose._neckRot, positionGain=kp, force=[50])
        bc.setJointMotorControlMultiDof(
            humanoid,
            rightHip,
            controlMode,
