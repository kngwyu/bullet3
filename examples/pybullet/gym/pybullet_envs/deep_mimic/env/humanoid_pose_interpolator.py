...
class HumanoidPoseInterpolator(object):
    ...
    def ComputeAngVelRel(self, ornStart, ornEnd, deltaTime, bullet_client):
        ...
        pos_diff, q_diff = bullet_client.multiplyTransforms([0, 0, 0], ornStartConjugate,
                                                            [0, 0, 0], ornEnd)
    ...
    def GetPose(self):
        pose = [
            ...
            self._chestRot[1], self._chestRot[2], self._chestRot[3], self._neckRot[0],
            self._neckRot[1], self._neckRot[2], self._neckRot[3], self._rightHipRot[0],
            self._rightHipRot[1], self._rightHipRot[2], self._rightHipRot[3],
            self._rightKneeRot[0], self._rightAnkleRot[0], self._rightAnkleRot[1],
            self._rightAnkleRot[2], self._rightAnkleRot[3], self._rightShoulderRot[0],
            self._rightShoulderRot[1], self._rightShoulderRot[2], self._rightShoulderRot[3],
            self._rightElbowRot[0], self._leftHipRot[0], self._leftHipRot[1], self._leftHipRot[2],
            self._leftHipRot[3], self._leftKneeRot[0], self._leftAnkleRot[0],
            self._leftAnkleRot[1], self._leftAnkleRot[2], self._leftAnkleRot[3],
    ...
    def Slerp(self, frameFraction, frameData, frameDataNext, bullet_client):
        ...
        self._baseOrn = bullet_client.getQuaternionSlerp(baseOrn1Start, baseOrn1Next,
                                                         frameFraction)
        ...
        self._chestRot = bullet_client.getQuaternionSlerp(chestRotStart, chestRotEnd,
                                                          frameFraction)
        ...
        self._rightAnkleRot = bullet_client.getQuaternionSlerp(rightAnkleRotStart,
