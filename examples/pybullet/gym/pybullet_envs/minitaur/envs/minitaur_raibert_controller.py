    ...
    def get_action(self, raibiert_controller):
        ...
        for i in raibiert_controller.swing_set:
            ...
            target_leg_extension = (
                raibiert_controller.nominal_leg_extension - self._leg_extension_clearance)
    ...
    def get_action(self, raibiert_controller):
        ...
        for i in raibiert_controller.stance_set:
            ...
            target_foot_position = -(
                raibiert_controller.behavior_parameters.stance_duration / 2 * current_speed -
                self._speed_gain * (current_speed - desired_forward_speed))
...
class MinitaurRaibertTrottingController(object):
    ...
    def __init__(self,
        ...
        nominal_leg_pose = foot_position_to_leg_pose((0,
                                                      -self._behavior_parameters.standing_height))
