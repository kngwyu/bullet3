...
class Humanoid(WalkerBase):
    ...
    def __init__(self):
        WalkerBase.__init__(
            self, 'humanoid_symmetric.xml', 'torso', action_dim=17, obs_dim=44, power=0.41)
    ...
    def robot_specific_reset(self, bullet_client):
        ...
        if self.random_yaw:
            ...
            if self.random_lean and self.np_random.randint(2) == 0:
                ...
                position = [0, 0, 1.4]
                orientation = [0, 0,
                               yaw]  # just face random direction, but stay straight otherwise
    ...
    def flag_reposition(self):
        ...
        if (self.flag):
            ...
            self._p.resetBasePositionAndOrientation(
                self.flag.bodies[0], [self.walk_target_x, self.walk_target_y, 0.7], [0, 0, 0, 1])
        else:
