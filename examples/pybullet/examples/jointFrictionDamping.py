...
p.resetDebugVisualizerCamera(
    cameraDistance=1, cameraYaw=23.2, cameraPitch=-6.6, cameraTargetPosition=[-0.064, .621, -0.2])
motorJointId = 1
...
while (1):
    ...
    p.setJointMotorControl2(
        minitaur, motorJointId, p.VELOCITY_CONTROL, targetVelocity=0, force=frictionForce)
